<template>
  <div class="phone-find-password">
    ...
    <div v-if="currentStep === 0">
      <div class="item">
        <i-input v-model="phoneParams.mobile" placeholder="请输入邮箱号码" @input="phoneEmpty = true"></i-input>
        <img src="../../assets/images/ic_postbox.svg" class="input-icon" alt>
        <div v-show="!hideErrorTips" class="error-tips">请输入正确的邮箱号码</div>
        <div v-show="phoneParams.mobile === '' && phoneEmpty === true" class="error-tips">邮箱号码不能为空</div>
      </div>
      <div class="pic-code">
        <div class>
          <i-input
    ...
    <div v-else-if="currentStep === 1">
      <div class="current-phone">
        <div>
          <span>验证当前账号绑定的邮箱号码：</span>
          <span>{{this.phoneParams.mobile}}</span>
        </div>
        <a href="javascript:;" @click="currentStep = 0">更换邮箱号</a>
      </div>
      ...
      <div class="pic-code">
        <div>
          ...
          ></i-input>
          <img src="../../assets/images/ic_dynamic password_postbox.svg" class="input-icon" alt>
          <div
