  ...
  export default {
    ...
    methods: {
      ...
      save () {
        ...
        if (!this.addData.task_toolkit_id || !this.addData.customer_id || !this.addData.name || !content) {
          this.isToast = true
        ...
        this.$http.post(Sys.addTips, this.qs.stringify(this.addData), {headers: {'Authorization': 'Bearer ' + this.$cookie.get('token')}}).then(res => {
