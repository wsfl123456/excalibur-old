<template>
  <div class="report-page">
    <div class="form-box-wrapper">
      ...
      <el-button type="primary" icon="el-icon-search" @click="serachSheet" style="margin-right: 20px">搜索</el-button>
      <el-dropdown >
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item>
            <el-button type="text" @click="exportSheet">Margin Sheet明细</el-button>
          </el-dropdown-item>
          <el-dropdown-item v-if="isSalesAdmin">
            <el-button type="text" @click="exportbaojiadanbyitem">报价单明细</el-button>
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
      <!-- <div>
      ...
      <el-button type="primary" icon="el-icon-download" @click="exportbaojiadanbyitem" v-if="isSalesAdmin">导出报价单明细</el-button>-->
    </div>
...
<script>
import "./index.less";
import { Task, Brand, Project, Hr } from "../../API/api";
...
export default {
  ...
  methods: {
    ...
    async getRole() {
      this.$http
        .post(Hr.marginRole, this.qs.stringify(), {
        ...
        .then(res => {
          ...
          if (_data.retCode === 0) {
            this.isSalesAdmin = _data.retData.isSalesAdmin;
          }
        });
    },
    async getBranList() {
    ...
    exportbaojiadanbyitem() {
      ...
      this.$http
        .post(Task.exportbaojiadanbyitem, this.qs.stringify(params), {
          headers: { Authorization: "Bearer " + this.$cookie.get("token") }
        })
        .then(res => {
